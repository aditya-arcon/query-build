...
export const CaseSection = (): JSX.Element => {
  ...
  const secondaryTabs = [
    ...
    { id: "case", label: "Case", isActive: true },
    { id: "arithmetic", label: "Arithmetic Operations", isActive: false },
  ];

  // Data for case options
  const caseOptions = [
    { id: "simple-case", label: "Simple CASE", isSelected: true },
    { id: "searched-case", label: "Searched CASE", isSelected: false },
    { id: "case-when", label: "CASE WHEN", isSelected: false },
    { id: "nested-case", label: "Nested CASE", isSelected: false },
  ];
            ...
            <div className="flex gap-3 flex-wrap">
              {caseOptions.map((option) => (
                <Button
                  ...
                  data-testid={`case-option-${option.id}`}
                >
                  {option.label}
                </Button>
              ))}
