...
export const FunctionsSection = (): JSX.Element => {
  ...
  const secondaryTabs = [
    ...
    { id: "functions", label: "Functions", isActive: true },
  ...
  // Data for function categories - matching Figma design
  const functionCategories = [
    { id: "date-yyyy", label: "Date/YYYY", isSelected: false },
    { id: "date-name", label: "Date Name", isSelected: false },
    { id: "left-trim", label: "Left Trim", isSelected: false },
    { id: "right-trim", label: "Right Trim", isSelected: false },
    { id: "concatenate", label: "Concatenate", isSelected: false },
    { id: "upper-case", label: "Upper Case", isSelected: true },
    { id: "lower-case", label: "Lower Case", isSelected: false },
  ];
          ...
          <CardContent className="flex flex-row gap-3 p-3 relative self-stretch w-full flex-[0_0_auto] bg-white rounded overflow-hidden">
            <div className="flex gap-3 flex-wrap">
              {functionCategories.map((func) => (
                <Button
                  key={func.id}
                  variant={func.isSelected ? "default" : "outline"}
                  size="sm"
