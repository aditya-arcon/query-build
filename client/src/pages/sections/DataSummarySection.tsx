...
export const DataSummarySection = (): JSX.Element => {
  ...
  const mainTabs = [
    { id: "columns", label: "Columns", isActive: true },
  ...
  const secondaryTabs = [
    { id: "data-type", label: "Data Type", isActive: true },
  ...
  // Data for data type options - matching Figma design
  const dataTypes = [
    { id: "string", label: "String", isSelected: true },
    { id: "integer", label: "Integer", isSelected: false },
    { id: "boolean", label: "Boolean", isSelected: false },
    { id: "date", label: "Date", isSelected: false },
    { id: "object", label: "Object", isSelected: false },
    { id: "data-types", label: "Data Types", isSelected: false },
    { id: "decimal", label: "Decimal", isSelected: false },
    { id: "timestamp", label: "Timestamp", isSelected: false },
  ];
    ...
    <div className="flex flex-col items-start gap-[11px] relative flex-1 self-stretch grow">
      <div className="flex-col gap-4 pt-[11px] pb-4 px-4 flex-1 grow flex items-start relative self-stretch w-full">
        ...
        <Card className="flex flex-col items-start gap-3 p-3 relative self-stretch w-full flex-[0_0_auto] bg-[#f6f7fb] border-none rounded">
          <Tabs defaultValue="data-type" className="w-full">
          ...
          <CardContent className="flex flex-row gap-3 p-3 relative self-stretch w-full flex-[0_0_auto] bg-white rounded overflow-hidden">
            <div className="flex gap-3 flex-wrap">
              {dataTypes.map((type) => (
                <Button
                  key={type.id}
                  variant={type.isSelected ? "default" : "outline"}
                  size="sm"
