...
export const AggregateSection = (): JSX.Element => {
  ...
  const secondaryTabs = [
    ...
    { id: "aggregate", label: "Aggregate", isActive: true },
  ...
  // Data for aggregate functions - matching Figma design
  const aggregateFunctions = [
    { id: "sum", label: "Sum", isSelected: true },
    { id: "count", label: "Count", isSelected: false },
    { id: "avg", label: "AVG", isSelected: false },
    { id: "min", label: "Min", isSelected: false },
    { id: "max", label: "Max", isSelected: false },
  ];
            ...
            <div className="flex gap-3">
              {aggregateFunctions.map((func) => (
                <Button
                  ...
                  data-testid={`aggregate-function-${func.id}`}
                >
                  {func.label}
                </Button>
              ))}
