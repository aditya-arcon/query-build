...
export const DistinctSection = (): JSX.Element => {
  ...
  const secondaryTabs = [
    ...
    { id: "distinct", label: "Distinct", isActive: true },
    { id: "case", label: "Case", isActive: false },
    { id: "arithmetic", label: "Arithmetic Operations", isActive: false },
  ];

  // Data for distinct options
  const distinctOptions = [
    { id: "distinct-all", label: "DISTINCT", isSelected: true },
    { id: "distinct-on", label: "DISTINCT ON", isSelected: false },
    { id: "count-distinct", label: "COUNT DISTINCT", isSelected: false },
  ];
    ...
    <div className="flex flex-col items-start gap-[11px] relative flex-1 self-stretch grow">
      <div className="flex-col gap-4 pt-[11px] pb-4 px-4 flex-1 grow flex items-start relative self-stretch w-full">
        ...
        <Card className="flex flex-col items-start gap-3 p-3 relative self-stretch w-full flex-[0_0_auto] bg-[#f6f7fb] border-none rounded">
          <Tabs defaultValue="distinct" className="w-full">
            ...
            <div className="flex gap-3">
              {distinctOptions.map((option) => (
                <Button
                  ...
                  data-testid={`distinct-option-${option.id}`}
                >
                  {option.label}
                </Button>
              ))}
